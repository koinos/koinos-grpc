...
public:
  ...
  GRPC_SYNC_METHOD_DECLARATIONS( account_history, ( get_account_history ) );

  GRPC_SYNC_METHOD_DECLARATIONS( block_store, (get_blocks_by_id)(get_blocks_by_height)( get_highest_block ) );

  GRPC_SYNC_METHOD_DECLARATIONS(
    chain,
  ...
  GRPC_SYNC_METHOD_DECLARATIONS( contract_meta_store, ( get_contract_meta ) );

  GRPC_SYNC_METHOD_DECLARATIONS( mempool, (get_pending_transactions)( check_pending_account_resources ) );

  GRPC_SYNC_METHOD_DECLARATIONS( p2p, ( get_gossip_status ) );

  GRPC_SYNC_METHOD_DECLARATIONS( transaction_store, ( get_transactions_by_id ) );
